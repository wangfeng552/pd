...
<div class="layout">
  ...
  <div class="main clear">
    <div class="m-l">
      ...
      <!-- 企业名称 -->
      <div class="column-pic prise-name">
        <div class="title2">
          <ul>
            <li class="fl1"></li>
    ...
    <div class="m-c">
      ...
      <!-- 活动名称 -->
      <div class="column-pic prise-name column-center">
        <div class="title2">
          <ul>
            <li class="fl1"></li>
    ...
    <div class="m-r">
      ...
      <!-- 平台 -->
      <div class="column-pic pingtai-bg pingtai">
        <div class="jb"></div>
...
.layout {
  ...
  // 企业名称
  .prise-name {
    background: url('~@/assets/images/qj_rect_2.png') 0 0 no-repeat;
    background-size: 100%;
  ...
  .dongtai-bg {
    background: url('~@/assets/images/qj_rect_4.png') 0 0 no-repeat;
    background-size: 100%;
    height: 182px;
  }

  .pingtai-bg {
    background: url('~@/assets/images/qj_rect_5.png') 0 0 no-repeat;
    background-size: 100%;
    height: 77px;
  }
  ...
  .column-center {
    width: 934px;
    background: url('~@/assets/images/qj_rect_3.png') 0 0 no-repeat;
    background-size: 100%;
